    ...
    resetPass: (req, res) => {
        ...
        User.getUserByEmail(newUser.email, function (err, user) {
            ...
            if (user) {
                ...
                User.resetPassToken(newUser, function (err, user) {
                    if (err) {
                        ...
                        nodemailer.createTestAccount((err, account) => {
                            ...
                            let mailOptions = {
                                ...
                                html: ` <b>Hello again user ...</b> ........... <hr></hr><br>
                                    <b>This is one time reset password link :</b> <a href="${req.headers.origin }/resetPass/${newUser.resetTokenHash}" 
                                    (click)="revert()">
                                     Click this link to verify</a>
                                    </br><hr>
                                    <b>Or</b> copy and paste below link to reset your password :
                                    <br>
                                    ${req.headers.origin }/resetPass/${newUser.resetTokenHash}
                                    `
                            };
